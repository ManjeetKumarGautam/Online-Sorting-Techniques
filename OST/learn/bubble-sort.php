    ...
    <div class="topic">
        ...
        <center>
            <div class="topic-detail">
                <h1>Sorting Algorithms - Bubble Sort</h1>
                <hr>
                <p>
                ...
                <div class="pages">
                    <a href="../learn/learning_home.php"><input type="button" value="Previous" class="btn-left"></a>
                    <a href="../learn/insertion-sort.php"><input type="button" value="Next" class="btn-right"></a>
                </div>
            </div>
        </center>
    </div>
