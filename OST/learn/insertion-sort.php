    ...
    <div class="topic">
        <div class="topic-list">
            ...
            <ul>
                ...
                <a href="../learn/insertion-sort.php">
                    <li class="see">Insertion Sort</li>
                </a>
        ...
        <center>
            <div class="topic-detail">
                <h1>Sorting Algorithms - Insertion Sort</h1>
                <hr>
                <p>
                ...
                <div class="pages">
                    <a href="../learn/bubble-sort.php"><input type="button" value="Previous" class="btn-left"></a>
                    <a href="../learn/merge-sort.php"><input type="button" value="Next" class="btn-right"></a>
                </div>
            </div>
        </center>
    </div>
