    ...
    <div class="header">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="../account/logout.php">LOGOUT</a></li>../learn/
            </ul>
        </div>
    </div>
    ...
    <div class="topic">
        ...
        <center>
            <div class="topic-detail">
                <h1>Sorting Algorithms - Merge Sort</h1>
                <hr>
                <p>
                ...
                <div class="pages">
                    <a href="../learn/insertion-sort.php"><input type="button" value="Previous"></a>
                    <a href="../learn/quick-sort.php"><input type="button" value="Next"></a>
                </div>
            </div>
        </center>
    </div>
