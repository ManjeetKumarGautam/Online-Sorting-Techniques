    ...
    <div class="topic">
        ...
        <center>
            <div class="topic-detail">
                ...
                <div class="pages">
                    <a href="../learn/merge-sort.php"><input type="button" value="Previous" class="btn-left"></a>
                    <a href="../learn/selection-sort.php"><input type="button" value="Next" class="btn-right"></a>
                </div>
            </div>
        </center>
    </div>
